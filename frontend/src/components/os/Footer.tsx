    ...
    <footer className="glass panel-glow mx-auto mt-12 max-w-[1440px] rounded-[1.8rem]">
      ...
      <div className="flex items-center justify-between px-8 py-3.5">
        ...
        <div className="flex items-center gap-1 text-[10px] text-secondary">
          Crafted with <span className="animate-pulse text-[12px] drop-shadow-[0_0_8px_rgba(255,20,147,0.8)]">💖</span> by <span className="font-medium text-white">Vikas Mishra</span>
        </div>
      </div>
